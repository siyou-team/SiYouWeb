 ...
 * @todo
 */
class Base_ProtocolModel extends Zero_Model
{
	public $_cacheName       = 'base';
	public $_tableName       = 'base_protocol';
	public $_tablePrimaryKey = 'cmd_id';
	...
	public $_multiCond = array(
		'base_protocol_cond'=>array(
		)
	);

	public $_validateRules = array('integer'=>array('cmd_id', 'rights_id', 'log'));
