 ...
 * @todo
 */
class Card_MediaModel extends Zero_Model
{
	public $_cacheName       = 'base';
	public $_tableName       = 'card_media';
	public $_tablePrimaryKey = 'card_media_id';
	...
	public $_multiCond = array(
		'card_media_cond'=>array(
		)
	);

	public $_validateRules = array('integer'=>array('card_media_id'));
