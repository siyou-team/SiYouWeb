 ...
 * @todo
 */
class Story_CollectionModel extends Zero_Model
{
    public $_cacheName       = 'story';
    public $_tableName       = 'story_collection';
    public $_tablePrimaryKey = 'collection_id';
    ...
    public $_multiCond = array(
        'story_collection_cond'=>array(
        )
    );

    public $_validateRules = array('integer'=>array('collection_id', 'story_id', 'user_id', 'collection_time'));
