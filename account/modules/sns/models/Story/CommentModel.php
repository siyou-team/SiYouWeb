 ...
 * @todo
 */
class Story_CommentModel extends Zero_Model
{
    public $_cacheName       = 'story';
    public $_tableName       = 'story_comment';
    public $_tablePrimaryKey = 'commect_id';
    ...
    public $_multiCond = array(
        'story_comment_cond'=>array(
        )
    );

    public $_validateRules = array('integer'=>array('commect_id', 'user_id', 'story_id', 'commect_state', 'to_user_id', 'commect_like_count'), 'date'=>array('commect_time'));
