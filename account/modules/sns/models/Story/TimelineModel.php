 ...
 * @todo
 */
class Story_TimelineModel extends Zero_Model
{
    public $_cacheName       = 'story';
    public $_tableName       = 'story_timeline';
    ...
    public $_multiCond = array(
        'story_timeline_cond'=>array(
        )
    );

    public $_validateRules = array('integer'=>array('user_id', 'story_id', 'timeline_time', 'timeline_type'));
