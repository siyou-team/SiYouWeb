 ...
 * @todo
 */
class User_BlockModel extends Zero_Model
{
    public $_cacheName       = 'user';
    public $_tableName       = 'user_block';
    public $_tablePrimaryKey = 'user_black_id';
    ...
    public $_multiCond = array(
        'user_block_cond'=>array(
        )
    );

    public $_validateRules = array('integer'=>array('user_black_id', 'user_id', 'black_id'), 'date'=>array('user_black_time'));
