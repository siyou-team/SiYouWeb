 ...
 * @todo
 */
class User_GroupRelModel extends Zero_Model
{
    public $_cacheName       = 'user';
    public $_tableName       = 'user_group_rel';
    public $_tablePrimaryKey = 'group_rel_id';
    ...
    public $_multiCond = array(
        'user_group_rel_cond'=>array(
            'group_id'=>null,
            'user_id'=>null
        )
    );

    public $_validateRules = array('integer'=>array('group_rel_id', 'group_id', 'user_id'));
