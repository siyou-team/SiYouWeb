 ...
 * @todo
 */
class User_ZoneMessageModel extends Zero_Model
{
    public $_cacheName       = 'user';
    public $_tableName       = 'user_zone_message';
    public $_tablePrimaryKey = 'zone_message_id';
    ...
    public $_multiCond = array(
        'user_zone_message_cond'=>array(
            'zone_id'=>null,
            'user_id'=>null
        )
    );

    public $_validateRules = array('integer'=>array('zone_message_id', 'user_id', 'zone_id', 'zone_message_is_delete', 'zone_message_type'), 'date'=>array('zone_message_time'));
