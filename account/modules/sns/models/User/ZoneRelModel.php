 ...
 * @copyright  Copyright (c) 2017-09-19, Xinze
 * @version    1.0
 * @todo
 */
class User_ZoneRelModel extends Zero_Model
{
    public $_cacheName       = 'user';
    public $_tableName       = 'user_zone_rel';
    public $_tablePrimaryKey = 'zone_rel_id';
    ...
    public $_multiCond = array(
        'user_zone_rel_cond'=>array(
            'zone_id'=>null,
            'user_id'=>null
        )
    );

    public $_validateRules = array('integer'=>array('zone_rel_id', 'zone_id', 'user_id', 'zone_rel_permission'));
