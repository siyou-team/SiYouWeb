...
<div style="background: url(<?=$this->img('login-slide.jpg')?>) no-repeat -1px; padding: 0px 0;background-size: 100% 100%;">
            ...
            <div class="col-sm-5">
                ...
                <form method="post" role="form" id="findpwd_step1" class="login-form fade-in-effect">
                    ...
                    <div class="login-header">
                        ...
                        <p style="display: none;"><?= sprintf(__('找回'). '%s' .__('密码'), Base_ConfigModel::getConfig('account_site_name'))?></p>
                    </div>
