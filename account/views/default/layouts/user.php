			...
			<ul class="nav nav-userinfo navbar-right">
				...
				<li class="dropdown xs-left">
					...
					<ul class="dropdown-menu messages" id="menu_msg_list_box">
						...
						<li class="external">
							<a href="<?=url('User_Message', 'index', 'sns')?>">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="user-info-sidebar" style="background-color: #fff;padding-top: 20px;">
                                    ...
                                    <a href="<?=url('User_Account', 'index', '', '', array(), 'default', 'e',  Zero_Registry::get('base_url') . '/account.php', true)?>" data-pjax="#account_content" class="user-img">
                                    ...
                                    <ul class="list-unstyled user-friends-count text-center">
                                        <li>
                                            <a href="<?=url('User_Favorites', 'item', null, '', array(), 'default', 'e', Zero_Registry::get('base_url') . '/index.php')?>"><span><?=$layout_data['user_row']['favorites_goods']?></span>
                                                <?=__('商品')?></a>
                                        </li>
                                        <li>
                                            <a href="<?=url('User_Favorites', 'store', null, '', array(), 'default', 'e', Zero_Registry::get('base_url') . '/index.php')?>"><span><?=$layout_data['user_row']['favorites_store']?></span>
                                            <?=__('店铺')?></a>
                                        </li>
                                        <?php if (Base_ConfigModel::ifSns()):?>
                                            <li>
                                                <a href="<?=url('User_Friend', 'fans', 'sns', '', array())?>"><span><?=intval(@$layout_data['user_row']['user_fans'])?></span>
                                                    <?=__('粉丝')?></a>
                                            </li>
                                            <li>
                                                <a href="<?=url('User_Friend', 'index', 'sns', '', array())?>"><span><?=intval(@$layout_data['user_row']['user_friend'])?></span>
                                                    <?=__('关注')?></a>
                                            </li>
                                        <?php endif;?>
                                    </ul>
                                ...
                                <div class="panel">
                                    <div class="panel-body nav-tabs-animate">
                                        <ul class="nav nav-tabs nav-tabs-line tabList">
                                            <li class="news <?=(($this->ctl=='User_Account' && $this->met=='index') ? 'active' : '')?>">
                                                <a href="<?=url('User_Account', 'index', '', '', array(), 'default', 'e',  Zero_Registry::get('base_url') . '/account.php', true)?>" data-toggle="tab" data-pjax="#account_content" aria-expanded="false">
                                                    <i class="icon fa-user-md" aria-hidden="true"></i> <?=__('账户信息')?>
                                                </a>
                                            </li>
                                            <li class="news <?=(($this->ctl=='User_Message' && $this->met=='index') ? 'active' : '')?>">
                                                <a href="<?=url('User_Message', 'index', 'sns', '', array(), 'default', 'e',  Zero_Registry::get('base_url') . '/account.php', true)?>" data-toggle="tab" data-pjax-href="#account_content" aria-expanded="false">
                                                    <i class="icon fa-comment-o" aria-hidden="true"></i> <?=__('消息')?>
    
                                                    <?php if($layout_data['user_row']['new_msg_num']):?>
                                                        <span class="badge badge-danger" class="J_new_msg_num"><?=$layout_data['user_row']['new_msg_num']?></span>
                                                    <?php endif;?>
                                                </a>
                                            </li>
                                            <!--<li class="news <?/*=(($this->ctl=='User_Friend' && $this->met=='index') ? 'active' : '')*/?>">
                                                <a href="<?/*=url('User_Friend', 'index', 'sns', '', array(), 'default', 'e',  Zero_Registry::get('base_url') . '/account.php', true)*/?>" data-toggle="tab" data-pjax="#account_content" aria-expanded="false">
                                                    <i class="icon fa-users" aria-hidden="true"></i> 关注
                                            ...
                                            <!--
                                            <li class="news <?=(($this->ctl=='User_Account' && $this->met=='history') ? 'active' : '')?>">
                                                <a href="<?=url('User_Account', 'history', '', '', array(), 'default', 'e',  Zero_Registry::get('base_url') . '/account.php', true)?>" data-toggle="tab" data-pjax="#account_content" aria-expanded="false">
                                                    <i class="icon fa-file-text-o" aria-hidden="true"></i> 日志
                                                </a>
                                            </li>-->
                                            <li class="news <?=(($this->ctl=='User_Security' && $this->met=='index') ? 'active' : '')?>">
                                                <a href="<?=url('User_Security', 'index', '', '', array(), 'default', 'e',  Zero_Registry::get('base_url') . '/account.php', true)?>" data-toggle="tab" data-pjax="#account_content" aria-expanded="false">
                                                    <i class="icon fa-key" aria-hidden="true"></i> <?=__('帐号安全')?>
                                                </a>
                                            </li>
					<!--
                                            <li class="news <?=(($this->ctl=='User_Connect' && $this->met=='index') ? 'active' : '')?>" role="presentation">
                                                <a href="<?=url('User_Connect', 'index', '', '', array(), 'default', 'e',  Zero_Registry::get('base_url') . '/account.php', true)?>" data-toggle="tab" data-pjax="#account_content" aria-expanded="false">
                                                    <i class="icon fa-magic" aria-hidden="true"></i> <?=__('绑定授权')?>
                                                </a>
                                            </li>-->
                                        </ul>
