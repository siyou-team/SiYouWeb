...
{   
     ...
     */
    protected static $langCookieVar = 'language';
     ...
     * @var array 允许语言列表
     */
    protected static $allowLangList = ['zh-CN','en','it'];
    ...
    public static function detect()
    {
        ...
        if (isset($_GET[self::$langDetectVar])) {
            // url 中设置了语言变量
            $langSet = $_GET[self::$langDetectVar];
...
//        }
        ...
        setcookie(self::$langCookieVar,self::$range,time() + self::$langCookieExpire,'/');
        return self::$range;
    }
