 ...
 * @todo
 */
class Goods_ComboModel extends Zero_Model
{
	public $_cacheName       = 'combo';
	public $_tableName       = 'goods_combo';
	public $_tablePrimaryKey = 'combo_id';
	public $_useCache        = false;
	public $fieldType = array('combo_detail'=>'JSON');
	...
	public function getCost($combo_detail = null)
	{
		$cost = 0;
		$combo_detail = json_decode($combo_detail,true);
		foreach($combo_detail as $k=>$v)
		{
			$cost+= $v['goods_cost']*$v['quantity'];
		}
