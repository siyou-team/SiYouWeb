 ...
 * @todo
 */
class Goods_SupplierModel extends Zero_Model
{
	public $_cacheName       = 'supplier';
	public $_tableName       = 'goods_supplier';
	public $_tablePrimaryKey = 'supplier_id';
