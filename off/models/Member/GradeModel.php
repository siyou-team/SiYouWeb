 ...
 * @todo
 */
class Member_GradeModel extends Zero_Model
{
	public $_cacheName       = 'grade';
	public $_tableName       = 'member_grade';
	public $_tablePrimaryKey = 'member_grade_id';
