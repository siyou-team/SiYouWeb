 ...
 * @todo
 */
class Member_LabelModel extends Zero_Model
{
	public $_cacheName       = 'label';
	public $_tableName       = 'member_label';
	public $_tablePrimaryKey = 'member_label_id';
	...
	public $_multiCond = array(
		'member_label_cond'=>array(
			'store_id'=>null,
			'member_label_id'=>null
		)
	);
