 ...
 * @todo
 */
class Role_RightsGroupModel extends Zero_Model
{
	public $_cacheName       = 'rightsGroup';
	public $_tableName       = 'role_rights_group';
	...
	public $_multiCond = array(
		'role_rights_group_cond'=>array(
			'rights_group_id'=>null,
			'store_id'=>null,
			'rights_ids'=>null
		)
	);
