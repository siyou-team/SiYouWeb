 ...
 * @todo
 */
class Shop_StaffDepartmentModel extends Zero_Model
{
	public $_cacheName       = 'department';
	public $_tableName       = 'shop_staff_department';
	public $_tablePrimaryKey = 'department_id';
	...
	public $_multiCond = array(
		'shop_staff_department_cond'=>array(
			'department_id'=>null,
			'store_id'=>null,
			'department_enable'=>null
		)
	);
