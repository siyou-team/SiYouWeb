    ...
    <div class="manage-edit-box">
        <div class="box-main">
            <form method="post" enctype="multipart/form-data" id="manage-form" name="manage-form">
                ...
                <input type="<?=i('is_admin') ? "text" : "hidden"?>" class="input-text form-control" name="is_admin" id="is_admin" value="<?=i('is_admin')?>"  placeholder="是否管理员" autocomplete="off" />
                <!--<div class="form-section">
                ...
                <?=i('is_admin') ? '<span id="subsite_id"></span>' : ''?>
