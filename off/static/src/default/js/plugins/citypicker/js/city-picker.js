        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    '<a class="active" data-count="province">'+__('省份')+'</a>' +
                    (this.includeDem('city') ? '<a data-count="city">'+__('城市')+'</a>' : '') +
                    (this.includeDem('district') ? '<a data-count="district">'+__('区县')+'</a>' : '') + '</div>' +
