    ...
    $.fn.extend({
        ...
        page: function (options) {
            ...
            return this.each(function () {
                ...
                obj.html('<div class="last" style="float:right">' + opts.lastPage + '</div><div class="next" style="float:right">' + opts.next + '</div><ul class="pagingUl">' + str1 + str + '</ul><div class="prv" style="float:right">' + opts.prv + '</div><div class="first" style="float:right">' + opts.firstPage + '</div>');
