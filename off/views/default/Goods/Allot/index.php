...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="<?=Zero_Registry::get('index_page')?>?ctl=Goods_Allot&met=index&typ=e"><?=__('调入确认')?></a></li>
</ul>
<div class="container">
...
<script src="<?=$this->js('controllers/goods/allotIn')?>" charset="utf-8"></script>