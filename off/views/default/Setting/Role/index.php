...
<ul class="nav nav-tabs">
	<li class="active"><a href="#" data-toggle="tab" aria-expanded="false"><span id="nav-title"><?=__('用户管理')?></span></a></li>
</ul>
<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                ...
                                <div class="form-group col-sm-8 col-md-8 col-lg-8 p-0">
                                    <input type="text" id="user_account" name="user_account" class="form-control" style="background: #fafafa;">
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                ...
                                <div class="form-group col-sm-8 col-md-8 col-lg-8 p-0">
                                    <input type="text" id="user_realname" name="user_realname" class="form-control">
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                ...
                                <div class="form-group col-sm-8 col-md-8 col-lg-8 p-0">
									...
									<p class="clear m-t-10"><?=__('修改时可不填写，表示不修改密码')?></p>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-6 col-md-6">
...
<script src="<?=$this->js('controllers/setting/role')?>" charset="utf-8"></script>