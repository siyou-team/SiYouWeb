$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?act=member_evaluate&op=again', { order_id:order_id}, function(result){
        ...
        $('input[name="upfile"]').ajaxUploadImage({
            ...
            success : function(element, result){
                ...
                element.parent().after('<div class="pic-thumb"><img src="'+result.data.file_url+'"/></div>')
                element.parent().siblings('.upload-loading').remove();
