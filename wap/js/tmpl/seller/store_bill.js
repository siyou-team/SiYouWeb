...
$(function() {
    ...
    function t() {
        ...
        $.request({
            type: "post",
            url: ApiUrl + "/index.php?act=seller_bill&op=list&page=" + page + "&curpage=" + curpage,
            data: {
            ...
            success: function(e) {
                ...
                $("#bill-list").on("click", ".goods_drop", goods_delete_r);
                $("#bill-list").on("click", ".goods_unshow", goods_unshow_r);
                    ...
                    $.request({
                        ...
                        success: function(a) {
                            if (a.datas && a.datas == 1) {
                                location.href = WapSiteUrl + "/tmpl/seller/store_orders_list.html";
                            } else {
                                $.sDialog({
                                    skin: "red",
                                    content: a.msg,
