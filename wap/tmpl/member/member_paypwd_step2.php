  ...
  <div class="sstouch-inp-con">
    ...
    <ul class="form-box">
      ...
      <li class="form-item">
        <h4><?=__('密码确认')?></h4>
        <div class="input-box">
          <input type="password" id="password1" name="password" class="inp" maxlength="20" placeholder="?=__('再次输入支付密码')?>" oninput="writeClear($(this));" onfocus="writeClear($(this));" />
          </div>
      </li>
    </ul>
...
<script type="text/javascript" src="../../js/tmpl/member_paypwd_step2.js"></script>
