...
<div class="sstouch-main-layout fixed-Width">
  <div class="sstouch-single-nav mb5 register-tab" style="display: none;">
    <ul>
    ...
    <form action="" method ="">
      <ul class="form-box">
        <li class="form-item">
          <h4><?=__('用&nbsp;户&nbsp;名')?></h4>
          <div class="input-box">
            <input type="text" placeholder="<?=__('请输入6-20个字符')?>" class="inp" name="username" id="username" oninput="writeClear($(this));"/>
            <span class="input-del"></span></div>
        </li>
        <li class="form-item">
          <h4><?=__('设置密码')?></h4>
          <div class="input-box">
            <input type="password" placeholder="<?=__('请输入6-20位密码')?>" class="inp" name="pwd" id="userpwd" oninput="writeClear($(this));"/>
            <span class="input-del"></span></div>
        </li>
        <li class="form-item">
          <h4><?=__('确认密码')?></h4>
