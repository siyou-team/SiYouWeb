            ...
            <div class="shops-list">
                    ...
                    <a v-bind:href="'/index/index/storeindex?storeid='+business.id" v-if="business.isadvert != 1">
                        ...
                        <div class="tl-grid-3-5">
                            ...
                            <div class="item">
                                ...
                                <div class="tl-fr red" v-if="business.store_points_consume_rate != 0"><?=__('送')?><span v-html="business.store_points_consume_rate +'%'"></span><?=__('积分')?></div>
                            </div>
                            <div class="item">
                            ...
                            <div class="item">
                                <span v-if="business.isdelivery == 1" ><span class="song"></span><?=__('起送')?><span v-html="business.delivery" ></span><?=__('元')?></span>
                                <span v-if="business.actualfreight <= 0">
                                          <?=__('免费配送')?>
                                        </span>
                                <span v-else>
                                            <?=__('配送费')?><span v-html="business.actualfreight" ></span>元
                                        </span>
                                <span style="float: right"><span v-html="business.salecount"></span><?=__('人已消费')?></span>
                            </div>
                        </div>
                    </a>
                ...
                <div>
                    <div>
                        ...
                        <p class="loading" v-show="!switchShow"><?=__('没有更多了...')?></p>
                    </div>
                </div>
        </section>
    </div>
...
<script>
    ...
    $(function(){
        if (true) {
            $("#page_diy_contents").load('./page_base.html',function(){
                var page_id = 2001;
                //loadSpecial(page_id);
