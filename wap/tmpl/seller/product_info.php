  ...
  <div class="sstouch-order-list">
    <ul id="order-list">
        ...
        <li class="product_list">
            ...
            <div class="wid-70"><input type="text" id="product_name" name="product_name" class="input-p ready"></div>
        </li>
        <li class="product_list">
        ...
        <li class="product_list">
            ...
            <div class="wid-70"><input type="text" id='item_cost_price' name="item_cost_price" class="input-p ready"></div>
        </li>
        <li class="product_list">
            <div class="wid-30">价格</div>
            <div class="wid-70"><input type="text" id='item_unit_price' name="item_unit_price" class="input-p ready"></div>
        </li>
        <li class="product_list">
            <div class="wid-30">会员价</div>
            <div class="wid-70"><input type="text" id="item_vip_price" name="item_vip_price" class="input-p ready"></div>
        </li>
        <li class="product_list">
        ...
        <li class="product_list">
            ...
            <div class="wid-70"><input type="text" id="item_quantity" name="item_quantity" class="input-p ready"></div>
        </li>
<!--         <li class="product_list">
 ...
 -->
      ...
      <div class="operate">
          <div class="ope-btn edit-opt">修改</div>
          <div class="ope-btn print">打印</div>
      </div>
  </div>
</div>
...
<script>
    ...
    $('.edit-opt').click(function(){
        location.href="./product_edit.php?product_id="+product_id;
    });
    $(function(){
        if (!ifLogin()){return}
        if (!product_id) {
