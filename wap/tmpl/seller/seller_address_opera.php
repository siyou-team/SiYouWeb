...
<header id="header" class="app-no-fixed">
  <div class="header-wrap">
    <div class="header-l"> <a href="seller_address_list.html"> <i class="zc zc-back back"></i> </a> </div>
    ...
    <div class="sstouch-inp-con">
      <ul class="form-box">
        ...
        <li class="form-item">
          <h4><?=__('所在地区')?></h4>
          <div class="input-box">
            <input name="district_info" type="text" class="inp" id="district_info" autocomplete="off" onchange="btn_check($('form'));" readonly/>
          </div>
        </li>
        <li class="form-item">
          <h4><?=__('详细地址')?></h4>
        ...
        <li>
          ...
          <div class="input-box">
            <label>
              <input type="checkbox" class="checkbox" name="is_default" id="is_default" value="0" />
              <span class="power"><i></i></span> </label>
          </div>
        </li>
      </ul>
      <div class="error-tips"></div>
      <div class="form-btn"><a class="btn" href="javascript:;"><?=__('保存地址')?></a></div>
    </div>
  </form>
</div>
...
<script type="text/javascript" src="../../js/tmpl/seller/seller_address_opera.js"></script>
</body>
</html>
<?php
