...
<script type="text/html" id="store_sliders_tpl">
    <ul class="swipe-wrap">
        ...
        <li class="item">
            <% if(s.img) {%>
            <% if (s.item >0) { %>
            <a href="supplier_product_detail.html?item_id=<%= s.item %>"><img alt="" src="<%= s.img %>"/></a>
            <% } else{ %>
...
<script type="text/html" id="goodsrank_product_favorite_num_tpl">
    ...
    <dl class="goods-item" style="width:20%;">
        <a href="supplier_product_detail.html?product_id=<%= v.product_id %>">
...
<script type="text/html" id="goods_recommend_tpl">
    <ul>
        ...
        <li class="goods-item" style="width:20%;">
            <a href="supplier_product_detail.html?product_id=<%= g.product_id %>">
        ...
        <li class="sotre-sale-con grid">
            ...
            <ul class=" goods-secrch-list">
                ...
                <li class="goods-item" item_id="<%= item_id%>">
                    <span class="goods-pic">
                        <a id="goods_pic<%= item_id%>" href="supplier_product_detail.html?item_id=<%= item_id%>">
                            <img src="<%= activity_item_rows[item_id].product_image%>!100x100.jpg">
                        </a>
                    </span>
                    <dl class="goods-info">
                        <dt class="goods-name">
                            <a href="supplier_product_detail.html?item_id=<%= item_id%>">
            ...
            <span class="goods-pic">
                        <a id="goods_pic<%= discount.item_id%>"
                           href="supplier_product_detail.html?item_id=<%= discount.item_id%>">
                            <img src="<%= activity_item_rows[discount.item_id].product_image%>!100x100.jpg">
                        </a>
                    </span>
            <dl class="goods-info">
                <dt class="goods-name">
                    <a href="supplier_product_detail.html?item_id=<%= discount.item_id%>">
...
<script type="text/javascript" src="../../js/tmpl/seller/supplier_store.js"></script>
