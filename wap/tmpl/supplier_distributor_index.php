...
<%if(items.length>0){%>
	...
	<%for(var i=0;i<items.length;i++){%>
        <li>
            <dl class="clearfix">
              <dt style="font-size: 0.8rem;float: left;color: #666"><%=items[i].store_name %></dt>
...
<script type="text/javascript" src="../../js/tmpl/seller/supplier_distributor_index.js"></script>
