...
<%if(items.length>0){%>
	...
	<%for(var i=0;i<items.length;i++){%>
        <li>
          ...
          <% } else { %>
          <a href="javascript:;" class="oper" data-status = '1' data-id = '<%=items[i].store_distributor_id%>' >通过</a><a href="javascript:;" data-status = '2' data-id="<%=items[i].store_distributor_id%>" class="oper">拒绝</a>
          <% } %>
